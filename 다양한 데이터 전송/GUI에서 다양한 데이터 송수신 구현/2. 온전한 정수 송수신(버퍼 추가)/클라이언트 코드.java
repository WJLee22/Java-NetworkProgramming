...
public class IntClientGUI2 extends JFrame {
	...
	public IntClientGUI2(String serverAddress, int serverPort) {
		super("IntClient GUI2");
	...
	public static void main(String[] args) {
		...
		IntClientGUI2 client = new IntClientGUI2(serverAddress, serverPort);
	}
